  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "$mainMod SHIFT, S, exec, bash ~/.dotfiles/homeModules/desktop/wm/hyprland/screenshot.sh"
        "ALT, space, exec, $menu"
        "$mainMod CTRL SHIFT, B, exec, bash ~/.dotfiles/homeModules/desktop/waybar/startup.sh"
